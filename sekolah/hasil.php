...
if ($hasilRes) while ($r = $hasilRes->fetch_assoc()) { 
    $r['rank'] = $rank++; 
    $rows[] = $r; 
...
$exportParams   = http_build_query(array_filter(['kelas'=>$filterKelas,'q'=>$q]));
    ...
    <div class="d-flex gap-2 flex-wrap">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="<?= BASE_URL ?>/sekolah/cetak_hasil.php<?= $exportParams ? '?'.$exportParams : '' ?>" target="_blank">Cetak Ranking</a></li>
                <li><a class="dropdown-item" href="<?= BASE_URL ?>/sekolah/cetak_hasil.php?mode=ledger<?= $exportParams ? '&'.$exportParams : '' ?>" target="_blank">Cetak Ledger</a></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table id="tblHasilSekolah" class="table table-hover datatable mb-0">
                        ...
                        <tr>
                            ...
                            <td><small><?= e($r['nama_kategori']) ?></small></td>
                    ...
                    <table class="table table-hover mb-0 datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><code style="font-size:11px"><?= e($p['kode']) ?></code></td>
